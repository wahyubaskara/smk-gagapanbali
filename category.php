                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li>
                                    <a href="category.php">MAKANAN <span class="badge pull-right">42</span></a>
                                </li>
                                <li class="active">
                                    <a href="category.php">PAKAIAN  <span class="badge pull-right">123</span></a>
                                </li>
                                <li>
                                    <a href="category.php">SOUVENIR  <span class="badge pull-right">11</span></a>
                                </li>
